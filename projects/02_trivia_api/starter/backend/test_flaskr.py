...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_404_failed_retrieve_categories(self):
    ...
    def test_404_failed_retrieve_questions(self):
    ...
    def test_failed_404_search_questions(self):
    ...
    def test_failed_404_get_questions_by_category(self):
