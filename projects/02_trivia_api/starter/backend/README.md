...
#### POST /quizzes
- General:
    - receive quiz category and previous questions parameters
    - return success value and random question object within the given category, if provided, and that is not one of the previous questions
